                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required
                            class="w-full border @error('name') border-red-400 @else border-slate-300 @enderror rounded-lg px-3 py-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-slate-400 transition-colors"
                            placeholder="e.g. Infrastructure, Signalling Systems...">
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            ...
                            placeholder="Brief description of what tenders belong in this category...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
